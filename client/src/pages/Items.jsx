  ...
  return (
    <div>
      ...
      <table className="table">
        <thead><tr><th>Name</th><th>Unit</th><th>Rate</th><th>Tax %</th><th>HSN/SAC</th></tr></thead>
        <tbody>
          {items.map((i) => (
            <tr key={i.id}><td>{i.name}</td><td>{i.unit}</td><td>₹{i.rate}</td><td>{i.tax_rate}%</td><td>{i.hsn_sac_code}</td></tr>
          ))}
        </tbody>
      </table>
    </div>
