...
export const api = {
  ...
  updateTermsTemplate: (id, payload) => request(`/api/terms-templates/${id}`, { method: "PUT", body: payload }),
  deleteTermsTemplate: (id) => request(`/api/terms-templates/${id}`, { method: "DELETE" }),
