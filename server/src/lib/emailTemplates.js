...
//
// This same file's content is mirrored at client/src/lib/emailTemplates.js
// so the "Email to Customer" popup can show the real, filled-in text for
// review before sending, not just a raw template with {{tokens}} still in
// it. The server never trusts what the client computed though — a request
// that skips subject/message (any non-UI caller) still gets a correctly
// merged email from here (2026-09-15).
